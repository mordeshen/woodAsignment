...
class ErrorHandling{
    ...
    companion object{
        ...
        const val ERROR_ITEM_UNABLE_TO_RETRIEVE = "Unable to retrieve the ITEM post. Try reselecting it from the list."
        ...
        const val ERROR_DELETE_ITEM_DOES_NOT_EXIST = "That ITEM post does not exist."
        const val ERROR_DELETE_ITEM_NEED_PERMISSION = "You don't have permission to delete that."
        const val ERROR_EDIT_ITEM_NEED_PERMISSION = "You don't have permission to edit that."
        const val ERROR_ITEM_DOES_NOT_EXIST = "That ITEMPost does not exist on the server."
        const val ERROR_ITEM_TITLE_LENGTH = "Enter a title longer than 5 characters."
        const val ERROR_ITEM_BODY_LENGTH = "Enter a body longer than 50 characters."
        const val ERROR_ITEM_IMAGE_SIZE = "That image is too large. Images must be less than 2 MB. Try a different image."
        const val ERROR_ITEM_IMAGE_ASPECT_RATIO = "Image height must not exceed image width. Try a different image."
        const val ERROR_ITEM_MISSING_FIELDS = "You must have a title, some content, and an image."
