...
class SuccessHandling {
    ...
    companion object{
        ...
        const val SUCCESS_ITEM_CREATED = "created"
        const val SUCCESS_ITEM_DELETED = "deleted"
        const val SUCCESS_ITEM_UPDATED = "updated"

        const val SUCCESS_ITEM_DOES_NOT_EXIST_IN_CACHE = "ITEM does not exist in the cache."
        const val SUCCESS_ITEM_EXISTS_ON_SERVER = "ITEM exists on the server and in the cache."
